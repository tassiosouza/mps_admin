    ...
    <Dialog open={open} aria-labelledby='alert-dialog-title' aria-describedby='alert-dialog-description'>
      ...
      <DialogContent>
        <DialogContentText id='alert-dialog-description'>
          This operation will delete the {clusters.length > 1 ? 'clusters' : 'cluster'}{' '}
          ...
          . All the subscriptions assigned to {clusters.length > 1 ? 'them' : 'it'} will be automatically detacheds. Are
