...
const ClustersPage = () => {
  ...
  return (
    <Grid container spacing={6}>
            ...
            {isLoaded ? (
              ...
              >
                ...
                {showClustering && showSubscriptions && (
                  <MarkerClusterer clickable={false} options={options}>
                    {clusterer => (
                      <>
      ...
      >
        <Alert elevation={3} onClose={handleClose} severity={messageInfo?.message === 'success' ? 'success' : 'error'}>
          {snackMessage}
        </Alert>
      </Snackbar>
    </Grid>
